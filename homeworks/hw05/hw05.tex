...
\title{MATH 241 Fall 2016 Homework \#5}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due 5PM KY604, Thursday, October 27, 2016 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read the section about the Bernoulli, Binomial, Geometric and Negative Binomial in Ross.% Chapter references are from the 7th edition.
