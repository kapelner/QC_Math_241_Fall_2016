...
\title{MATH 241 Fall 2016 FINAL Homework (\#9)}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due 3PM, Monday, December 12, 2016 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read about the central limit theorem, statistical inference: confidence intervals for one sample proportion and hypothesis tests for a population proportion.
